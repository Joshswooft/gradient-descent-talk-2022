...
<ul>
  ...
  <li>'c' is known as the y-intercept or where the line crosses the y-axis.</li>
</ul>
<section>
...
<section>
  ...
  <h3>Why is Multicollinearity a Potential Problem?</h3>
  <p>
  ...
  <h4>The 2 types of multicollinearity</h4>
  <ul>
    <li>
  ...
  <h4>Do I have to fix Multicollinearity?</h4>
  <p>
